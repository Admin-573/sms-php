            ...
            <fieldset
                ...
                <form action="Admin/Admin.php" method="post">
                    <div style="margin-bottom: 15px ; text-align: center">
                        <input class="btn panel" type="submit" name="btnAdmin" id="btnAdmin" value="Admin" style="
                            padding-left: 40px;
                            padding-right: 40px;
                            padding-top: 7px;
                            padding-bottom: 7px;
                ...
                <form action="Faculty/Faculty.php" method="post">
                    <div style="margin-bottom: 15px ; text-align: center">
                        <input class="btn panel" type="submit" name="btnFaculty" id="btnFaculty" value="Faculty" style="
                            padding-left: 36px;
                            padding-right: 36px;
                            padding-top: 7px;
                            padding-bottom: 7px;
                ...
                <form action="Student/Student.php" method="post">
                    <div style="margin-bottom: 15px ; text-align: center">
                        <input class="btn panel" type="submit" name="btnStudent" id="btnStudent" value="Student " style="
                            padding-left: 30px;
                            padding-right: 30px;
                            padding-top: 7px;
                            padding-bottom: 7px;
