...
<head>
    <title>Faculty Update Panel</title>
</head>
...
<body id="grad_back">
    ...
    <div class="split left">
        <div class="centered">
            ...
            <p style="font-family: Comic Sans MS ; color: white ; font-size: 20px;">Dear Admin You Can Update Faculties
                Here ~</p>
        </div>
    </div>
        ...
        <div class="centered">
            ...
            <fieldset
                ...
                <form method="POST">
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$FACULTY_NAME] ?>" type="text" name="faculty_name"
                            id="faculty_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$FACULTY_EMAIL] ?>" type="email" name="faculty_email"
                            id="faculty_email" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$FACULTY_PASSWORD] ?>" type="password" name="faculty_password"
                            id="faculty_password" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$FACULTY_QUALIFICATION] ?>" type="text"
                            name="faculty_qualification" id="faculty_qualification" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
                    ...
                    <div>
                        <input class="btn add_fac" type="submit" name="add_faculty" id="add_faculty"
                            value="Update Faculty" style="
                                    padding-left: 28px;
                                    padding-right: 28px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
