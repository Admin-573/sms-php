...
<body id="grad_back">
    ...
    <div class="split left">
        <div class="centered">
            ...
            <p style="font-family: Comic Sans MS ; color: white ; font-size: 20px;">Dear Admin You Can Add Students Here
                ~</p>
        </div>
    </div>
            ...
            <fieldset
                ...
                <legend style="font-family: Comic Sans MS ; color: white">
                    <fieldset
                        ...
                        Add Students</fieldset>
                </legend>

                <form action="#" method="post">

                    <div style="margin-top: 7px;">
                        <input type="text" name="student_mno" id="student_mno" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="student_name" id="student_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="email" name="student_email" id="student_email" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="password" name="student_password" id="student_password" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="student_result" id="student_result" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
                    ...
                    <div>
                        <input class="btn add_stud" type="submit" name="add_student" id="add_student"
                            value="Add Student" style="
                                    padding-left: 28px;
                                    padding-right: 28px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
