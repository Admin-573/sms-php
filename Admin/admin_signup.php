    ...
    <body>
        ...
        <div class="split left">
            <div class="centered">
                ...
                <p style="font-family: Comic Sans MS ; color: white">"Student Management System is a tool that is
                    designed to track, maintain and manage all the data generated by a School"</p>
            </div>
        </div>
                            ...
                            <td>
                                <tr>
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="name" name="admin_name" id="admin_name" style="margin-inline-start: 7px ; padding: 7px ; margin-top: 5px;
                                    ...
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="text" name="admin_contact" id="admin_contact" style="margin-inline-start: 7px ; padding: 7px ; margin-top: 5px;
                                                            width: 250px ; border-radius:12px ; 
                                                            outline-color: transparent ; border-color: transparent"
                                    ...
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="email" name="admin_email" id="admin_email" style="margin-inline-start: 7px ; padding: 7px ; margin-top: 5px;
                                                            width: 250px ; border-radius:12px ; 
                                                            outline-color: transparent ; border-color: transparent"
                                    ...
                                    <div style="margin-bottom: 15px">
                                        <input class="btn sign_des" type="submit" name="btnSignUp" id="btnSignUp"
                                            value="SignUp" style="
                                        padding-left: 32px;
                                        padding-right: 32px;
                                        padding-top: 7px;
                    ...
                    <tr>
                        <form action="#" method="post">
                            ...
                            <div style="margin-bottom: 17px">
                                ...
                                <button class="btn already" name="already_acc" id="already_acc" style="
                                    padding-left: 48px;
                                    padding-right: 48px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
