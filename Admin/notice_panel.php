            ...
            <fieldset
                ...
                <form action="#" method="post">
                    ...
                    <div style="margin-top: 7px;">
                        <input type="date" name="faculty_notice_date" id="faculty_notice_date" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="faculty_notice_name" id="faculty_notice_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="faculty_notice_des" id="faculty_notice_des" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px "
                    ...
                    <div>
                        <input class="btn add_fac" type="submit" name="add_notice_faculty" id="add_notice_faculty"
                            value="Faculty Notice" style="
                                    padding-left: 28px;
                                    padding-right: 28px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
        ...
        <div class="centered">
            ...
            <fieldset
                ...
                <form action="#" method="post">
                    ...
                    <div style="margin-top: 7px;">
                        <input type="date" name="student_notice_date" id="student_notice_date" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                            border-radius: 12px; outline-color: transparent;
                                            border-color: transparent; margin-bottom: 3px"
                            placeholder="Enter Date Of Notice" required>
                    </div>
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="student_notice_name" id="student_notice_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                            border-radius: 12px; outline-color: transparent;
                                            border-color: transparent; margin-bottom: 3px"
                            placeholder="Enter Topic Of Notice" required>
                    </div>
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="student_notice_des" id="student_notice_des" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                            border-radius: 12px; outline-color: transparent;
                                            border-color: transparent; margin-bottom: 3px "
                            placeholder="Enter Description Of Notice">
                    </div>
                    ...
                    <div>
                        <input class="btn add_fac" type="submit" name="add_notice_student" id="add_notice_student"
