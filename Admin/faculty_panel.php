...
<body id="grad_back">
    ...
    <div class="split left">
        <div class="centered">
            ...
            <p style="font-family: Comic Sans MS ; color: white ; font-size: 20px;">Dear Admin You Can Add Faculties
                Here ~</p>
        </div>
    </div>
            ...
            <fieldset
                ...
                <legend style="font-family: Comic Sans MS ; color: white">
                    <fieldset
                        ...
                        Add Faculties</fieldset>
                </legend>

                <form action="#" method="post">

                    <div style="margin-top: 7px;">
                        <input type="text" name="faculty_mno" id="faculty_mno" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="faculty_name" id="faculty_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="email" name="faculty_email" id="faculty_email" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="password" name="faculty_password" id="faculty_password" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="faculty_qualification" id="faculty_qualification" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px"
