    ...
    <body>
        ...
        <div class="split right">
            <div class="centered">
                ...
                <fieldset
                    style="border-radius:15px ; border-color:white ; border-width:3px ; background-color: #FF7474 ; margin-bottom: 25px">
                            ...
                            <td>
                                <tr>
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="email" name="admin_email" id="admin_email" style="margin-inline-start: 7px ; padding: 7px ; 
                                    ...
                                    <table>
                                        ...
                                        <td>
                                            <div>
                                                <input type="password" name="admin_password" id="admin_password" style="margin-inline-start: 7px ; padding: 7px ; margin-top: 5px;
                                                        width: 250px ; border-radius:12px ; 
                                                        outline-color: transparent ; border-color: transparent ; "
                                    ...
                                    <div style="margin-bottom: 15px">
                                        <input class="btn signin" type="submit" name="btnLogin" id="btnLogin"
                                            value="SignIn" style="
                                    padding-left: 32px;
                                    padding-right: 32px;
                                    padding-top: 7px;
                    ...
                    <tr>
                        <form action="#" method="post">
                            <div style="margin-bottom: 17px">
                                <button class="btn already" name="newAccount" id="newAccount" style="
                                    padding-left: 48px;
                                    padding-right: 48px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
                        ...
                        <form action="#" method="post">
                            <div style="margin-bottom: 15px">
                                <button class="btn signin" name="go_to_home" id="go_to_home" style="
                                padding-left: 32px;
                                padding-right: 32px;
                                padding-top: 7px;
                                padding-bottom: 7px;
