...
<body id="grad_back">
    ...
    <div class="split left">
        <div class="centered">
            ...
            <fieldset
                style="margin-left: -30%; margin-right: -30% ; border-radius:15px ; border-color:white ; border-width:4px ; background-color: #14397d ; margin-bottom: 25px">
                <div class="scrollable-container"
                    style="margin-top: 5px; margin-bottom: 5px; margin-left: 5px; margin-right: 5px; background-color: #77b5d9;">
                    <legend style="font-family: Comic Sans MS ; color: white ; margin-bottom: 12px;">
                        <fieldset
                            style="border-radius:15px ; border-color:white ; border-width:4px ; background-color: #14397d">
                            Read Notice Here</fieldset>
                    </legend>
                    ...
                    if ($dbquery) {
                        while ($rows = mysqli_fetch_array($queryExe)) {
                            ...
                            <div>
                                <fieldset
                                    style="border-radius:15px ; border-color:white ; border-width:4px ; background-color: #F9E795 ; margin-bottom: 10px">
    ...
    <div class="split right">
        <div class="centered">
            ...
            <fieldset
                style="border-radius:15px ; border-color:white ; border-width:4px ; background-color: #FF7474 ; margin-bottom: 25px">

                <legend style="font-family: Comic Sans MS ; color: white">
                    <fieldset
                        style="border-radius:15px ; border-color:white ; border-width:4px ; background-color: crimson">
                        Add Notice Here</fieldset>
                </legend>

                <form action="#" method="post">

                    <div style="margin-top: 7px;">
                        <input type="date" name="fc_student_notice_date" id="fc_student_notice_date" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="fc_student_notice_name" id="fc_student_notice_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                            border-radius: 12px; outline-color: transparent;
                                            border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input type="text" name="fc_student_notice_des" id="fc_student_notice_des" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                            border-radius: 12px; outline-color: transparent;
                                            border-color: transparent; margin-bottom: 3px "
                    ...
                    <div>
                        <input class="btn add_fac" type="submit" name="fc_add_notice_student" id="fc_add_notice_student"
                            value="Student Notice" style="
                                        padding-left: 28px;
                                        padding-right: 28px;
                                        padding-top: 7px;
                                        padding-bottom: 7px;
