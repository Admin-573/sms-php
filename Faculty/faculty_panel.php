                    ...
                    <div class="box_right" style="overflow-y:scroll ; overflow-x:hidden ">
                        <h2 style="text-align:center">
                            ...
                            <form style="margin-top:8px" action="" method="post">
                                <input class="text_des" type="text" placeholder="Search..." id="search_student_box"
                                    name="search_student_box" />
                                <input class="button des" type="submit" id="btnSearch" name="btnSearch"
                                    value="Search" />
                            </form>
                        </h2>
                        <center>
                            <table border="6px" cellspacing="0px" cellpadding="6px"
                                style="margin:8px; background-color: transparent;border-radius: 6px; border-color: #81490F;">
                                <tr>
                                ...
                                if (isset($_POST['btnSearch'])) {
                                    ...
                                    $val = $_POST['search_student_box'];

                                    $sql = "SELECT * FROM $STUDENT_ADD WHERE $STUDENT_NAME LIKE '%${val}%' ";
                                    ...
                                    if ($data) {
                                        while ($row = mysqli_fetch_array($queryExe)) {
                                            ...
                                            <tr style="font-family: Comic Sans MS; font-size: 16px; ">
                                                ...
                                                <td>
                                                    <a href="student_update.php?student_email=<?php echo $row['student_email'] ?> "><button
                                                            class="button des">UPDATE</button></a>
                                                </td>
                                                <td>
                                                    <a href="student_delete.php?student_email=<?php echo $row['student_email'] ?> "><button
                                    ...
                                    mysqli_query(
                                        $con,
                                        "CREATE TABLE IF NOT EXISTS $STUDENT_ADD($STUDENT_MNO BIGINT UNIQUE,
