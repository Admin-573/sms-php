    ...
    <center>
        <table>
            <td>
                <div class="box_left">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ; color:orange ; font-weight: bold;">Java</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="java_ch" id="java_ch" style="border-radius:12px ; 
                                        ...
                                        margin-top:5px;
                                        margin-left:35px;
                                        padding-left:10px" placeholder="Add Chapters With Description" required>
                        </div>
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="java_des" id="java_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                                        ...
                                        margin-left:10px;
                                        padding-left:10px;
                                        padding-right:10px" placeholder="Date Of Assignment Submission !" required>
                        </div>
                        <div>
                ...
                <div class="box_left">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ;color:orange ; font-weight: bold">Python</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="python_ch" id="python_ch" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 200px ;
                                        height:25px;
                        ...
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="python_des" id="python_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                        ...
                        <div>
                            <input class="btn signdes" type="submit" name="python_assign" id="python_assign"
                                value="Genrate" style=" padding-left: 30px ; padding-right: 30px;
                                        margin-left:160px;
                                        margin-top:6px;
                                        padding-top: 2px;padding-bottom: 2px;
                                        font-family:Comic Sans MS;
                ...
                <div class="box_left">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ;color:orange ; font-weight: bold">Kotlin</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="kotlin_ch" id="kotlin_ch" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 200px ;
                                        height:25px;
                        ...
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="kotlin_des" id="kotlin_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                        ...
                        <div>
                            <input class="btn signdes" type="submit" name="kotlin_assign" id="kotlin_assign"
                                value="Genrate" style=" padding-left: 30px ; padding-right: 30px;
                                        margin-left:160px;
                                        margin-top:6px;
                                        padding-top: 2px;padding-bottom: 2px;
            ...
            <td>
                <div class="box_right">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ;color:crimson ; font-weight: bold">C
                        & C++</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="c_ch" id="c_ch" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 200px ;
                                        height:25px;
                        ...
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="c_des" id="c_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                ...
                <div class="box_right">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ;color:crimson ; font-weight: bold">Php</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="php_ch" id="php_ch" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 200px ;
                                        height:25px;
                        ...
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="php_des" id="php_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                        ...
                        <div>
                            <input class="btn signdes_right" type="submit" name="php_assign" id="php_assign"
                                value="Genrate" style=" padding-left: 30px ; padding-right: 30px;
                                        margin-left:160px;
                                        margin-top:6px;
                                        padding-top: 2px;padding-bottom: 2px;
                ...
                <div class="box_right">
                    <label
                        style="font-size:24px; margin-left:18px ; margin-top:14px ;color:crimson ; font-weight: bold">Cyber-Security</label>
                    <form action="" method="post">
                        <div style="margin-left:25px">
                            Chapters
                            <input type="text" name="cs_ch" id="cs_ch" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 200px ;
                                        height:25px;
                        ...
                        <div style="margin-left:25px">
                            Submit Date
                            <input type="date" name="cs_des" id="cs_des" style="border-radius:12px ; 
                                        border-color:transparent ; 
                                        outline-color:transparent ; 
                                        width: 190px ;
                                        height:25px;
                        ...
                        <div>
                            <input class="btn signdes_right" type="submit" name="cs_assign" id="cs_assign"
                                value="Genrate" style=" padding-left: 30px ; padding-right: 30px;
                                        margin-left:160px;
                                        margin-top:6px;
                                        padding-top: 2px;padding-bottom: 2px;
