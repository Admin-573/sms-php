...
<body id="grad_back">
    ...
    <div class="split left">
        <div class="centered">
            ...
            <p style="font-family: Comic Sans MS ; color: white ; font-size: 20px;">Dear Faculty You Can Update Students
                Here ~</p>
        </div>
    </div>
        ...
        <div class="centered">
            ...
            <fieldset
                ...
                <form method="POST">
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$STUDENT_NAME] ?>" type="text" name="student_name"
                            id="student_name" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$STUDENT_EMAIL] ?>" type="email" name="student_email"
                            id="student_email" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                        border-radius: 12px; outline-color: transparent;
                                        border-color: transparent; margin-bottom: 3px"
                    ...
                    <div style="margin-top: 7px;">
                        <input value="<?php echo $row[$STUDENT_RESULT] ?>" type="text" name="student_result"
                            id="student_result" style="margin-inline-start: 7px;padding: 7px; width: 250px;
                                    border-radius: 12px; outline-color: transparent;
                                    border-color: transparent; margin-bottom: 3px" placeholder="Update Student Result"
                            required>
                    </div>

                    <div>
                        <input class="btn add_fac" type="submit" name="add_faculty" id="add_faculty"
                            value="Update Student" style="
                                    padding-left: 28px;
                                    padding-right: 28px;
                                    padding-top: 7px;
                                    padding-bottom: 7px;
